...
* [SEN2NEON](https://github.com/ESAOpenSR/SEN2NEON) -> Spatially and spectrally harmonized Sen-2 + Multispectral NEON for super-resolution of all Sen2 bands at 2.5m, including HR reference
* [LR-HR-dataset](https://github.com/HadiaKha/LR-HR-dataset) -> paired Low Resolution Sentinel-2 and High Resolution PlanetScope patches (333x333x3) over the YarHussain region, Swabi District, Pakistan, suitable for super-resolution, land cover classification, and geospatial analyses
...
* [SwissCrop25](https://huggingface.co/datasets/EOA-team/SwissCrop25) -> a national-scale crop mapping benchmark for Switzerland spanning seven growing seasons (2019–2025), combining Sentinel-2 time series, daily temperature observations, 73 crop categories, and five non-crop land-cover classes. Paper: SwissCrop25: A National Multi-Year Benchmark for Operational Crop Mapping
...
* [Space2Ground 2.0](https://zenodo.org/records/21219542) -> [GitHub](https://github.com/Agri-Hub/Space2Ground-2.0). A parcel-level agricultural monitoring dataset for Cyprus in 2022 combining Sentinel-1/2 time series, official crop labels, and 46,050 street-level images associated with 8,581 parcels. Paper: Space2Ground 2.0: A Multi-Source Dataset and Framework for Agricultural Monitoring through Fusion of Street-Level and Satellite Imagery
...
* [RSRCC](https://huggingface.co/datasets/google/RSRCC) -> Remote Sensing Remote Change Captioning dataset of paired before/after satellite images with natural language descriptions of semantic changes such as new construction, demolition, road changes, vegetation changes, and residential development
* [ChatEarthNet](https://github.com/zhu-xlab/ChatEarthNet) -> A Global-Scale Image-Text Dataset Empowering Vision-Language Geo-Foundation Models, utilizes Sentinel-2 data with captions generated by ChatGPT
