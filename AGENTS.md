...
```markdown
* [Dataset name](https://github.com/owner/repository) -> Short, factual description of the dataset. Paper: [Full Paper Title](https://doi.org/or/arxiv/url)
```
...
- The full paper name and a direct paper, DOI, or arXiv link, when a paper exists.
...
```markdown
* [Dataset name](https://official.dataset/page) -> [GitHub](https://github.com/owner/repository). Short, factual description. Paper: [Full Paper Title](https://doi.org/or/arxiv/url)
```
